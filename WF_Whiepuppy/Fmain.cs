...
namespace WF_Whiepuppy
{
    public partial class Fmain : Form
    {
        ...
        private static void OnPacketArrival(object sender, PacketCapture e)
        {
            ...
            // Kiểm tra xem gói tin có phải là IPv6 hay không
            if (ipPacket == null)
            {
                ...
                if (ipv6Packet != null)
                {
                    ...
                    if (Application.OpenForms["PacketViewerForm"] is PacketViewerForm packetViewerForm)
                    {
                        packetViewerForm.AddPacketInfo(sourceIp, destinationIp, protocol, rawPacket.Data, ipvVersion);
                    }
                }
            }
            else
